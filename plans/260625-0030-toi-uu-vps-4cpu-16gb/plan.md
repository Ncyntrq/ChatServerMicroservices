...
> Liên quan: [debug-260625-0024-tinh-trang-lag-he-thong.md](../reports/debug-260625-0024-tinh-trang-lag-he-thong.md)
...
1. CI (Jenkins/SonarQube) bắt buộc chung VPS app không? → quyết định Phase 2.1.
2. Có thể dùng GitHub Actions build image thay Jenkins-on-VPS không?
3. Observability có cần chạy 24/7 hay chỉ bật khi cần debug?
